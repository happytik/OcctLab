...
class QXLIB_API CSizingControlBar : public baseCSizingControlBar
{
...
class QXLIB_API CSCBDockContext : public CDockContext
{
public:
// Construction
...
class QXLIB_API CSCBMiniDockFrameWnd : public baseCSCBMiniDockFrameWnd
{
